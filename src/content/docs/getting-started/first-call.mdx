...
<img src="/screenshot-getting-started-first-call-1.png" alt="Channel sidebar with the active channel highlighted" />
...
<img src="/screenshot-getting-started-first-call-2.png" alt="Voice panel with the three activation mode radio options" />
