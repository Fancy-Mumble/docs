...
<PlantUML alt="Diagram of broadcaster uploading once, server SFU fanning out to N viewers" code={`
@startuml
...
skinparam noteFontColor #311b92

left to right direction

component "Broadcaster" as B

package "Fancy Mumble Server" {
  component "SFU\\nUDP 10000" as SFU
}

component "Viewer 1" as V1
component "Viewer 2" as V2
component "Viewer N" as VN
