...
| | **None** | **Full Archive** <Badge text="Experimental" variant="danger" /> | **Signal V1** |
|---|---|---|---|
...
| **Full Archive (all messages)** <Badge text="Experimental" variant="danger" /> | `fancy_v1_full_archive` | yes | full history (subject to retention / message-count cap) | HMAC challenge against an online key custodian; relay cap scales with online member count |
...
### Full Archive <Badge text="Experimental" variant="danger" />

<Aside type="danger" title="Not recommended - experimental with potential security issues">
