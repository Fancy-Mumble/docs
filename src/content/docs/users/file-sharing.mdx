...
<div class="screenshot-placeholder">
  &nbsp;Screenshot placeholder: chat with an image attachment card and a file attachment card.
</div>
...
<div class="screenshot-placeholder">
  &nbsp;Screenshot placeholder: Share file dialog with the three access modes.
</div>
